...
<c:set var="managectx" value="${pageContext.request.contextPath}/static/management"/>
<html>
<head>
    <meta charset="utf-8">
    <title>Movies 后台管理系统</title>
    ...
    <link rel="icon" href="${managectx}/images/favicon.ico">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/management/lib/layui-v2.5.5/css/layui.css" media="all">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/management/css/layuimini.css" media="all">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/management/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
...
<script src="${pageContext.request.contextPath}/static/management/lib/layui-v2.5.5/layui.js?v=1.0.4" charset="utf-8"></script>
<script src="${pageContext.request.contextPath}/static/management/js/lay-config.js?v=1.0.4" charset="utf-8"></script>
<script>
