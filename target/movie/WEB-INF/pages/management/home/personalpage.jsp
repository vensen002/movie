        ...
        <div class="layui-card text-center">
          <div class="layui-card-body">
            <div class="layadmin-homepage-pad-ver">
              <img class="layadmin-homepage-pad-img" src="${ctx}/static/layuiadmin/style/res/template/portrait.png" width="96" height="96">
            </div>
            ...
            <div class="grid-demo">
              <div class="panel-body layadmin-homepage-shadow">
                <a href="javascript:;" class="media-left">
                  <img src="${ctx}/static/layuiadmin/style/res/template/portrait.png" height="46px" width="46px">
                </a>
                <div class="media-body">
                  ...
                  <img class="h-img" src="${ctx}/static/layuiadmin/style/res/template/huge.jpg">
                  <div class="media">
                    ...
                    <div class="media-left">
                      <ul class="list-inline">
                        <li>
                          <a href="javascript:;">
                            <img class="img-xs" src="${ctx}/static/layuiadmin/style/res/template/portrait.png">
                          </a>
                        </li>
                        <li>
                          <a href="javascript:;">
                ...
                <div class="layui-card-body">
                  <div class="layui-row layui-col-space15">
                    <div class="layui-col-md4">
                      <img src="${ctx}/static/layuiadmin/style/res/template/portrait.png">
                    </div>
                    <div class="layui-col-md4">
                      <img src="${ctx}/static/layuiadmin/style/res/template/portrait.png">
                    </div>
