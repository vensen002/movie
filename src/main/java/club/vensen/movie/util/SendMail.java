...
public class SendMail {
    ...
    public static String myEmailAccount = "vensen002@outlook.com";
    public static String myEmailPassword = "SONG643258";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1219877637@qq.com";
