...
<!-- //for-mobile-apps -->
<link href="${ctx}/static/foreground/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- pop-up -->
<link href="${ctx}/static/foreground/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
<!-- //pop-up -->
<link href="${ctx}/static/foreground/css/easy-responsive-tabs.css" rel='stylesheet' type='text/css'/>
<link rel="stylesheet" type="text/css" href="${ctx}/static/foreground/css/zoomslider.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/static/foreground/css/style.css" />
<link href="${ctx}/static/foreground/css/font-awesome.css" rel="stylesheet">
<script type="text/javascript" src="${ctx}/static/foreground/js/modernizr-2.6.2.min.js"></script>
<!--/web-fonts-->
...
<!--/main-header-->
  <!--/banner-section-->
	<div id="demo-1" data-zs-src='["${ctx}/static/foreground/images/2.jpg", "${ctx}/static/foreground/images/1.jpg", "${ctx}/static/foreground/images/3.jpg","${ctx}/static/foreground/images/4.jpg"]' data-zs-overlay="dots">
										...
										<div class="w3_agile_featured_movies">
											<div class="col-md-5 video_agile_player">
										            <div class="video-grid-single-page-agileits">
														<div data-video="f2Z65fobH2I" id="video"> <img src="${ctx}/static/foreground/images/11.jpg" alt="" class="img-responsive" /> </div>
													</div>
...
A film by Abhinay Deo, Produced by Vipul Amrutlal Shah, JA entertainment Pvt. Ltd....</p>
										     ...
										     <div class="col-md-7 wthree_agile-movies_list">
														<div class="w3l-movie-gride-agile">
															<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m1.jpg" title="Movies Pro" class="img-responsive" alt=" ">
														...
														<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m2.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m3.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m4.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m5.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m6.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m7.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m8.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
							...
							<div class="tab2">
								<div class="tab_movies_agileinfo">
										<div class="w3_agile_featured_movies">
											<div class="col-md-5 video_agile_player">
										            <div class="video-grid-single-page-agileits">
														<div data-video="fNKUgX8PhMA" id="video1"> <img src="${ctx}/static/foreground/images/22.jpg" alt="" class="img-responsive" /> </div>
													</div>
...
A girl in a small town forms an unlikely bond with a recently-paralyzed man she's taking care of....</p>
										     ...
										     <div class="col-md-7 wthree_agile-movies_list">
														<div class="w3l-movie-gride-agile">
															<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m9.jpg" title="Movies Pro" class="img-responsive" alt=" ">
																<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
															</a>
																<div class="mid-1 agileits_w3layouts_mid_1_home">
																	<div class="w3l-movie-text">
														...
														<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m10.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m11.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m12.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m13.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m14.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m15.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
												...
												<div class="w3l-movie-gride-agile">
												<a href="single.html" class="hvr-sweep-to-bottom"><img src="${ctx}/static/foreground/images/m16.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
						...
						<div class="tab3">
								<div class="tab_movies_agileinfo">
										<div class="w3_agile_featured_movies">
											<div class="col-md-5 video_agile_player">
										            <div class="video-grid-single-page-agileits">
														<div data-video="BXEZFd0RT5Y" id="video2"> <img src="${ctx}/static/foreground/images/44.jpg" alt="" class="img-responsive" /> </div>
													</div>
										     ...
										     <div class="col-md-7 wthree_agile-movies_list second-top">
												...
												<div class="ribben">
											 	...
											 	<div class="col-md-5 video_agile_player second-top">
										            <div class="video-grid-single-page-agileits">
														<div data-video="BXEZFd0RT5Y" id="video3"> <img src="${ctx}/static/foreground/images/44.jpg" alt="" class="img-responsive" /> </div>
													</div>
					...
					<div class="footer-grids w3-agileits">
						...
						<h4>Latest Movies</h4>
							<div class="footer-grid1">
								<div class="footer-grid1-left">
									<a href="single.html"><img src="${ctx}/static/foreground/images/1.jpg" alt=" " class="img-responsive"></a>
								</div>
							...
							<div class="footer-grid1">
								<div class="footer-grid1-left">
									<a href="single.html"><img src="${ctx}/static/foreground/images/2.jpg" alt=" " class="img-responsive"></a>
								</div>
								<div class="footer-grid1-right">
							...
							<div class="footer-grid1">
								...
								<div class="footer-grid1-left">
									<a href="single.html"><img src="${ctx}/static/foreground/images/4.jpg" alt=" " class="img-responsive"></a>
								</div>
								<div class="footer-grid1-right">
									<a href="single.html">eveniet ut molesti</a>
							...
							<div class="footer-grid1">
								<div class="footer-grid1-left">
									<a href="single.html"><img src="${ctx}/static/foreground/images/3.jpg" alt=" " class="img-responsive"></a>
								</div>
								<div class="footer-grid1-right">
									<a href="single.html">earum rerum tenet</a>
						...
						<div class="col-md-2 footer-grid">
						   <h4 class="b-log"><a href="index.html"><span>M</span>ovies <span>P</span>ro</a></h4>
							...
							<a href="single.html"><img src="${ctx}/static/foreground/images/m1.jpg" alt=" " class="img-responsive"></a>
							</div>
							<div class="footer-grid-instagram">
							<a href="single.html"><img src="${ctx}/static/foreground/images/m2.jpg" alt=" " class="img-responsive"></a>
							</div>
							<div class="footer-grid-instagram">
								<a href="single.html"><img src="${ctx}/static/foreground/images/m3.jpg" alt=" " class="img-responsive"></a>
							</div>
							<div class="footer-grid-instagram">
							<a href="single.html"><img src="${ctx}/static/foreground/images/m4.jpg" alt=" " class="img-responsive"></a>
							</div>
							<div class="footer-grid-instagram">
								<a href="single.html"><img src="${ctx}/static/foreground/images/m5.jpg" alt=" " class="img-responsive"></a>
							</div>
							<div class="footer-grid-instagram">
							<a href="single.html"><img src="${ctx}/static/foreground/images/m6.jpg" alt=" " class="img-responsive"></a>
							</div>
...
<script src="${ctx}/static/foreground/js/jquery-1.11.1.min.js"></script>
...
<script type="text/javascript" src="${ctx}/static/foreground/js/jquery.zoomslider.min.js"></script>
		<!-- search-jQuery -->
				<script src="${ctx}/static/foreground/js/main.js"></script>
			<script src="${ctx}/static/foreground/js/simplePlayer.js"></script>
			<script>
				$("document").ready(function() {
					$("#video").simplePlayer();
				});
			...
			<!-- pop-up-box -->  
		<script src="${ctx}/static/foreground/js/jquery.magnific-popup.js" type="text/javascript"></script>
	<!--//pop-up-box -->
...
<script src="${ctx}/static/foreground/js/easy-responsive-tabs.js"></script>
<script>
$(document).ready(function () {
...
<link href="${ctx}/static/foreground/css/owl.carousel.css" rel="stylesheet" type="text/css" media="all">
<script src="${ctx}/static/foreground/js/owl.carousel.js"></script>
<script>
	$(document).ready(function() { 
...
<!--/script-->
<script type="text/javascript" src="${ctx}/static/foreground/js/move-top.js"></script>
<script type="text/javascript" src="${ctx}/static/foreground/js/easing.js"></script>
...
<!--end-smooth-scrolling-->
	<script src="${ctx}/static/foreground/js/bootstrap.js"></script>
