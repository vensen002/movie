    ...
    <div class="layui-layout layui-layout-admin">
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          <%-- logo处 --%>
          <div class="layui-logo" lay-href="${ctx}/manager/console">
            <span>管理面板</span>
          </div>
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <a lay-href="${ctx}/manager/personalpage">个人主页</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="${ctx}/manager/console">控制台</a>
                </dd>
                <dd data-name="console">
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd>
                  <a lay-href="${ctx}/administrators/">后台管理员</a>
                </dd>
                <dd>
                  <a lay-href="${ctx}/role/">角色管理</a>
                </dd>
              </dl>
            </li>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="${ctx}/manager/personalpage" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
